	...
	//Fallthrough
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_2_2, "TEMPER TANTRUM"},
				{StageId_2_3, "UN ADIEU"},
				{StageId_3_1, "TRACKSTAR"},
				{StageId_3_2, "BABY BOB"},
				{StageId_3_3, "JUST LIKE YOU"},
				{StageId_4_1, "INSIGNIFICANCE"},
				{StageId_4_2, "KITTY"},
				{StageId_4_3, "CREDITS"},
				{StageId_5_1, "IMPROBABLE OUTSET"},
				{StageId_5_2, "MADNESS"},
				{StageId_5_3, "HELLCLOWN"},
				{StageId_6_1, "EXPURGATION"},
				{StageId_6_2, "GAMETOONS"},
				{StageId_6_3, "WOCKY"},
				{StageId_7_1, "BEATHOVEN"},
				{StageId_7_2, "HAIRBALL"},
				{StageId_7_3, "NYAW"},
			};
